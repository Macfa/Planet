            ...
            <div>
                ...
                <div class="body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="post" value="{{ $coin_setup->post }}">
                    </div>
                    <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">댓글 작성</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="" name="comment" value="{{ $coin_setup->comment }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="" name="day_limit" value="{{ $coin_setup->day_limit }}">
                    </div>
